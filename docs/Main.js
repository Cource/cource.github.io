...
var $author$project$Main$getBlog = function (blogId) {
						...
						model,
						{
							blogContent: function () {
								if (content.$ === 'Err') {
									...
									var val = content.a;
									return $author$project$Main$Success(val);
								}
							}()
						}),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$href('/blog/' + blog.blogId)
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Main$footer = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('nopyright')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('The source of this website is open.')
						])),
					$elm$html$Html$text('You can find it on: github.com/cource/cource.github.io')
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$src(social.image)
									]),
								_List_Nil),
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Jeff Jacob Joy')
						])),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('designer')
										]),
									_List_fromArray(
										[
...
var $author$project$Main$projectCard = function (project) {
	return A2(
		$elm$html$Html$a,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('techs')
							]),
						A2(
							$elm$core$List$map,
							function (techIcon) {
								return A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$src(techIcon.path),
											$elm$html$Html$Attributes$alt(techIcon.alt)
										]),
									_List_Nil);
							},
							project.techs)),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('project-bg'),
						A2($elm$html$Html$Attributes$style, 'background', 'linear-gradient(90deg, #114642, transparent), url(' + (project.image.path + ')'))
					]),
				_List_Nil)
			]));
};
var $author$project$Main$portfolio = function (projects) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Some stuff that I made')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				A2($elm$core$List$map, $author$project$Main$projectCard, projects))
			]));
};
		...
		function () {
			switch (status.$) {
				...
				default:
					...
					if (_v1.$ === 'Ok') {
						var body = _v1.a;
						return $hecrj$html_parser$Html$Parser$Util$toVirtualDom(body);
					} else {
						return _List_fromArray(
							[
								$elm$html$Html$text('Could not Load Content!')
							]);
					}
			}
		}());
						...
						case 'Home':
							return _List_fromArray(
								[
									...
									$author$project$Main$blogList(model.blogIndex)
								]);
						case 'Blog':
							return _List_fromArray(
								[
